...
static class MenuController
{
    ...
    ///     ''' </remarks>
    private readonly static string[][] _menuStructure = new[] { new string[] { "PLAY", "SETUP", "SCORES", "CHANGEBACKGROUND",  "QUIT" }, new string[] { "RETURN", "SURRENDER", "QUIT" }, new string[] { "EASY", "MEDIUM", "HARD" } };
	...
	private const  int CHANGE_BACKGROUND = 3;

    private const  int MAIN_MENU_PLAY_BUTTON = 0;
    private const  int MAIN_MENU_SETUP_BUTTON = 1;
    private const  int MAIN_MENU_TOP_SCORES_BUTTON = 2;    
    private const  int MAIN_MENU_CHANGE_BACKGROUND_BUTTON = 3;
	...
	public static int numOfClicks = 0; // For the ChangeBackground feature. each click cycles through the available bacgrouds
	...
	public static void HandleChangeBackgroundInput()
    {
        HandleMenuInput(CHANGE_BACKGROUND, 0, 0);
    }
	...
	public static void DrawChangeBackground()
    {
        // Clears the Screen to Black
        // SwinGame.DrawText("Main Menu", Color.White, GameFont("ArialLarge"), 50, 50)

        DrawButtons(CHANGE_BACKGROUND);
    }
    ...
    private static void PerformMainMenuAction(int button)
    {
        switch (button)
        {
            ...
            case MAIN_MENU_CHANGE_BACKGROUND_BUTON:
                {
                    PerformChangeBackgroundAction(button);
                    break;
                }
	...
	private static void PerformChangeBackgroundAction(int button)
    {		
		numOfClicks++;
        ShowMessage("Loading fonts...", numOfClicks);
		if(numOfClicks > 3)
		{
			numOfClicks = 0;
		}
        ...
        {   
            case 0:
                {SwinGame.DrawBitmap(GameResources.GameImage("Background1"), 0, 0);
                    break;
                }
            ...
            case 2:
                {
					SwinGame.DrawBitmap(GameResources.GameImage("Background2"), 0, 0);
                    break;
                }
				
			case 3:
                {
					SwinGame.DrawBitmap(GameResources.GameImage("Background3"), 0, 0);
                    break;
                }
        }
    }
